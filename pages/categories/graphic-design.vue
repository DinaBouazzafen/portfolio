<template>
  <div>
    ...
    <main class="mx-auto max-w-4xl space-y-6 px-4 mb-20">
      <h1 class="text-6xl font-bold road-rage-regular capitalize">Graphic Design</h1>
      <div class="mb-10">
        <NuxtLink :to="`/page`">
          <span>
...
// Use computed to reactively filter posts
const filteredPosts = computed(() => posts.value || []); // Fallback to empty array if data is null
